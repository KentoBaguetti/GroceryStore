...
exports.deleteProduct = exports.updateProduct = exports.getProductById = exports.getProductsByCategory = exports.getProducts = exports.addProduct = void 0;
...
const updateProduct = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const product = yield productModel_1.default.findOneAndUpdate({ id: Number.parseInt(id) }, updates, { new: true });
        if (!product) {
            return res.status(404).json({ error: "Product not found" });
        }
        return res
...
const deleteProduct = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
        const product = yield productModel_1.default.findOneAndDelete({ id: Number.parseInt(id) });
        if (!product) {
            return res.status(404).json({ error: "Product not found" });
        }
